...
// this function will replay a batch of txs from t0 to t1, and generate the account states at t1
// original account states and program (contracts) data need to be provided
